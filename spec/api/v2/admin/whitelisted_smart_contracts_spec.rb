...
describe API::V2::Admin::WhitelistedSmartContracts, type: :request do
  ...
  describe 'GET /api/v2/admin/whitelisted_smart_contracts/:id' do
    ...
    it 'returns information about specified WhitelistedSmartContract' do
      api_get "/api/v2/admin/whitelisted_smart_contracts/#{whitelisted_address.id}", token: token
    ...
    it 'returns error in case of invalid id' do
      api_get '/api/v2/admin/whitelisted_smart_contracts/120', token: token
    ...
    it 'return error in case of not permitted ability' do
      api_get "/api/v2/admin/whitelisted_smart_contracts/#{whitelisted_address.id}", token: level_3_member_token
  ...
  describe 'POST /api/v2/admin/whitelisted_smart_contracts/new' do
    it 'create whitelisted_smart_contracts' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/new', token: token, params: { description: 'Test', address: 'blank', blockchain_key: 'eth-rinkeby' }
      result = JSON.parse(response.body)
    ...
    it 'checked required params' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/new', token: token, params: { }
    ...
    it 'validate state' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/new', token: token, params: { description: 'Test', address: 'blank', blockchain_key: 'eth-rinkeby', state: 'invalid' }
    ...
    it 'return error in case of not permitted ability' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/new', params: { description: 'Test', address: 'blank', blockchain_key: 'eth-rinkeby'}, token: level_3_member_token
  ...
  describe 'POST /api/v2/admin/whitelisted_smart_contracts/update' do
    it 'update WhitelistedSmartContract' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/update', token: token, params: { id: WhitelistedSmartContract.first.id, address: 'test' }
      result = JSON.parse(response.body)
    ...
    it 'update WhitelistedSmartContract with new description' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/update', token: token, params: { id: WhitelistedSmartContract.first.id, description: 'test'}
      result = JSON.parse(response.body)
    ...
    it 'update WhitelistedSmartContract with new state' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/update', token: token, params: { id: WhitelistedSmartContract.first.id, state: 'disabled' }
    ...
    it 'validate blockchain_key' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/update', token: token, params: { id: WhitelistedSmartContract.first.id, blockchain_key: 'test' }
    ...
    it 'validate status' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/update', token: token, params: { id: WhitelistedSmartContract.first.id, state: 'disable' }
    ...
    it 'checked required params' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/update', token: token, params: { }
    ...
    it 'return error in case of not permitted ability' do
      api_post '/api/v2/admin/whitelisted_smart_contracts/update', params: { id: WhitelistedSmartContract.first.id, status: 'disabled' }, token: level_3_member_token
